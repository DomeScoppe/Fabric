    ...
    static class VisualStudio
    {
        ...
        public static void OpenVisualStudio(string solutionPath)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.Log(MessageType.Error, "Failed to open Visual Studio instance");
            }
            finally
            {
        ...
        public static bool AddFilesToSolution(string solution, string projectName, string[] files)
        {
            ...
            {
                Debug.WriteLine(ex.Message);
                Logger.Log(MessageType.Error, $"Failed to add files to project {projectName} in Visual Studio solution.");
                return false;
            }
